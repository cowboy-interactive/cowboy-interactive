...
export default function About() {
  ...
  return (
    <Container all={"align-items: center"}>
      ...
      <Section
        all={`padding: 80px 0 80px 0; width: 100vw; justify-content: center; background: ${themes.button}}`}
      >
        <Stats />
      </Section>
      ...
      >
        <Img src="/interior-5.jpg" />
        <Container
          all={"margin:0 0 0 40px;"}
          small={"margin:0 0 60px 0; align-items: center; text-align: center;"}
          xsmall={"align-items: flex-start; text-align: left;"}
        >
          <H3 all={`margin: 0 0 20px 0; maxWidth: 800px;`}>Our story</H3>
      ...
      >
        <Container
          ...
          xsmall={"align-items: flex-start; text-align: left;"}
        >
          <H3 all={`margin: 0 0 20px 0;`}>Our mission</H3>
          <H2 all={"margin: 0 0 40px 0; maxWidth: 800px;"}>
